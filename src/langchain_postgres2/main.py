''' use : https://github.com/pthom/northwind_psql '''
import os
import logging
...
if __name__ == "__main__":
    question = "which shipping region has had the most orders? - and for that region, which customer had the most orders?"
